        ...
        <div class="sidebar p-3" style="width: 280px;">
            ...
            <ul class="nav flex-column mb-auto">
                @if($role === 'admin_gudang')
                    ...
                    <li class="nav-item"><a href="{{ route('stok.opening-balance') }}" class="nav-link"><i class="bi bi-database-add"></i> Opening Balance</a></li>
                    <li class="nav-item"><a href="{{ route('admin.system-check') }}" class="nav-link"><i class="bi bi-shield-check"></i> System Check</a></li>
                    ...
                    <li class="nav-item"><a href="{{ route('laporan.index') }}" class="nav-link"><i class="bi bi-file-earmark-text"></i> Laporan & Ekspor</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="dropdown me-3">
                            <button class="btn btn-light position-relative" type="button" id="dropdownNotif" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi bi-bell"></i>
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger d-none" id="bellBadgeCount">
                                    0
                                </span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="dropdownNotif" style="width: 300px;">
                                <li><h6 class="dropdown-header fw-bold">Notifikasi Terkini</h6></li>
                                <div id="notifDropdownList">
                                    <li><span class="dropdown-item text-center text-muted small py-3">Memuat...</span></li>
                                </div>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <div class="d-flex justify-content-between px-3 pb-1">
                                        <a href="#" class="text-decoration-none small" id="markAllReadBtn">Tandai semua dibaca</a>
                                        <a href="{{ route('notifikasi.index') }}" class="text-decoration-none small fw-bold">Lihat semua</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
