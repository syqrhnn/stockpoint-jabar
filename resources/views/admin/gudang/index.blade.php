...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
        <h5 class="mb-0 text-primary"><i class="bi bi-building"></i> Manajemen Data Gudang</h5>
    ...
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-5">
                <input type="text" id="searchInput" class="form-control" placeholder="Cari nama atau lokasi gudang...">
            </div>
        </div>
      ...
      <form id="dataForm" onsubmit="saveData(event)">
          ...
          <div class="modal-body">
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="lokasi" required maxlength="200">
                  <div class="invalid-feedback" id="err_lokasi"></div>
              </div>
              <div class="mb-3">
                  <label class="form-label">Kapasitas (Unit/Pcs) <span class="text-danger">*</span></label>
                  <input type="number" class="form-control" id="kapasitas" required min="1">
                  <div class="invalid-feedback" id="err_kapasitas"></div>
              </div>
          </div>
...
@push('scripts')
<script>
    const API_URL = '/admin/api/gudang';
        ...
        if (paginator.data.length === 0) {
            ...
            paginator.data.forEach(item => {
                ...
                tr.innerHTML = `
                    ...
                    <td>${item.lokasi}</td>
                    <td>${Number(item.kapasitas).toLocaleString('id-ID')}</td>
